...
def get_params():
    params = {
        'weight': r'runs\prune-walnut-new\yolov8-GSA-lamp-exp1-finetune2\weights\best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'LayerCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM,HiResCAM
...
if __name__ == '__main__':
    ...
    model(r'G:\DATASET\walnut_new\val\images', 'results3')